...
export default {
  ...
  data(){
    return {
      ...
      close_copy:"We pride ourselves on the products we deliver with over 95% coming from American owned companies.  While our aesthetic sensibilities are a significant asset, we demand durability along with quality, and our products are designed to to last for at least a decade with a minimum of a 5 year guarantee.",
